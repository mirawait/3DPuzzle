...
namespace Unity.UIElements.Editor.Debugger
{
    ...
    {
        #if UIE_PACKAGE
        [MenuItem("Window/Analysis/UIR Package Allocator Debugger", false, 202, true)]
        #else
...
#if UIE_PACKAGE
            root.AddStyleSheetPath("Packages/com.unity.ui/PackageResources/StyleSheets/UIElementsDebugger/UIRAllocatorDebugger.uss");
#else
