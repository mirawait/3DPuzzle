...
namespace Unity.UIElements.Editor.Debugger
{
    class UIElementsEventsDebugger : EditorWindow
    {
        ...
        #if UIE_PACKAGE
        [MenuItem("Window/UI Toolkit/Package Events Debugger", false, 3010, true)]
        #else
...
#if UIE_PACKAGE
            VisualTreeAsset template = EditorGUIUtility.Load("Packages/com.unity.ui/PackageResources/UXML/UIElementsDebugger/UIElementsEventsDebugger.uxml") as VisualTreeAsset;
#else
...
#if UIE_PACKAGE
            rootVisualElement.AddStyleSheetPath("Packages/com.unity.ui/PackageResources/StyleSheets/UIElementsDebugger/UIElementsEventsDebugger.uss");
#else
