                ...
                switch (attrName)
                {
                    ...
                    case "contentContainer":
                        ...
                        if (attrName == "contentContainer")
                        {
                            ...
                            logger.LogError(ImportErrorType.Syntax, ImportErrorCode.DeprecatedAttributeName, attrName, Error.Level.Warning, elt);
                            logger.LogError(ImportErrorType.Syntax, ImportErrorCode.ReplaceByAttributeName, "content-container", Error.Level.Warning, elt);
#endif
                        }
