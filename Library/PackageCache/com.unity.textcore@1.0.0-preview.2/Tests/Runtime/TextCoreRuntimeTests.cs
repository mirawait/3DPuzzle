...
{
    [Category("TextCoreBasicRuntimeTests")]
    class TextCoreRuntimeTests
    {
        //
        private const string m_TextBlock_00 = "abcdefghijklmnopqrstuvwxyz ABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789";
        ...
        */
        ...
        [Test]
        public void FontAssetDynamicCreationTest()
        {
            Assert.AreEqual(1, 1);
            ...
            //
            // string characters = "abcdefghifklmnopqrstuvwxyz ABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789";
            //
            // for (int i = 0; i < fonts.Length; i++)
            // {
            //     FontAsset fontAsset = FontAsset.CreateFontAsset(fonts[i]);
            //
            //     Assert.True(fontAsset.TryAddCharacters(characters));
            //
            //     for (int j = 0; j < characters.Length; j++)
            //     {
            //         Character character = FontAssetUtilities.GetCharacterFromFontAsset(characters[j], fontAsset, false, FontStyles.Normal, TextFontWeight.Regular, out bool isAlternativeTypeFace);
