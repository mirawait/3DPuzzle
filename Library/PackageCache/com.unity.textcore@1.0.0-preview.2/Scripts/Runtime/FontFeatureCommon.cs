...
namespace UnityEngine.TextCore.Text
{
    ...
    public struct GlyphPair
    {
        ...
        public GlyphPair(uint firstGlyphIndex, uint secondGlyphIndex)
        {
        ...
        internal GlyphPair(GlyphPairAdjustmentRecord record)
        {
        ...
        internal GlyphPair(TMP_GlyphPairAdjustmentRecord record)
        {
            firstGlyphIndex = record.firstAdjustmentRecord.glyphIndex;
            secondGlyphIndex = record.secondAdjustmentRecord.glyphIndex;
            key = secondGlyphIndex << 16 | firstGlyphIndex;
